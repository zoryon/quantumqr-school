...
import Step3 from "@/components/QRCodeSteps/Step3";
...
const CreatePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-7xl bg-gray-800/40 backdrop-blur-lg rounded-3xl py-8 p-5 shadow-2xl border border-gray-700/50 relative">
